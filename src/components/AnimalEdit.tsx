...
import { useAnimalsEdit } from "../hooks/useAnimals";
...
export const AnimalEdit = ({ closeEvent, data: editdata }: any) => {
  const { mutate } = useAnimalsEdit(editdata.ownerId);
  ...
  const form = useForm<FormValues>({
    defaultValues: {
      ...
      dob: moment(editdata.dob).format("YYYY-MM-DDTkk:mm"),
    },
  });
